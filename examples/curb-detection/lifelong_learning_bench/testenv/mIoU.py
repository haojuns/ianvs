...
@ClassFactory.register(ClassType.GENERAL, alias="mIoU")
def mIoU(y_true, y_pred, **kwargs):
    args = ValArgs()
    ...
    current_mIoU = evaluator.Current_Intersection_over_Union_Curb()
    future_mIoU = evaluator.Future_Intersection_over_Union_Curb()

    print("current mIoU: {}, future mIoU: {}".format(current_mIoU, future_mIoU))
