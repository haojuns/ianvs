...
__all__ = ('TaskUpdateDecisionAll', )


@ClassFactory.register(ClassType.KM, alias="TaskUpdateDecisionAll")
class TaskUpdateDecisionAll:
    """
    ...
    def set_index_url(self, task_index):
        if isinstance(task_index, str):
            task_index = FileOps.load(task_index)
        self.task_index = task_index
