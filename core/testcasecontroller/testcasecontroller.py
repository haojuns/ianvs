...
class TestCaseController:
    ...
    def build_testcases(self, test_env, test_object):
        ...
        """
        #test_object: {'type': 'algorithms', 'algorithms': [{'name': 'rfnet_latenttask_learning', 'url': './examples/curb-detection/latenttask_learning_bench/testalgorithms/rfnet/rfnet_algorithm.yaml'}]}
        test_object_type = test_object.get("type")
        test_object_config = test_object.get(test_object_type)
        #test_object_config : [{'name': 'rfnet_latenttask_learning', 'url': './examples/curb-detection/latenttask_learning_bench/testalgorithms/rfnet/rfnet_algorithm.yaml'}]
