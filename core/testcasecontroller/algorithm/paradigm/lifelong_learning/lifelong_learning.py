...
class LifelongLearning(ParadigmBase):
    ...
    def _inference(self, edge_task_index, data_index_file, rounds):
        ...
        [array(['/data/user8302433/fc/dataset/curb-detection/train_data/images/real_aachen_000016_000019_leftImg8bit.png'],
            ...
            dtype='<U103'), array(['/data/user8302433/fc/dataset/curb-detection/train_data/images/real_aachen_000019_000019_leftImg8bit.png'],
            dtype='<U103'), array(['/data/user8302433/fc/dataset/curb-detection/train_data/images/real_aachen_000021_000019_leftImg8bit.png'],
            dtype='<U103'), array(['/data/user8302433/fc/dataset/curb-detection/train_data/images/real_aachen_000024_000019_leftImg8bit.png'],
