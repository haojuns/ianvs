...
class SingleTaskLearning(ParadigmBase):
    ...
    def run(self):
        ...
        job = self.build_paradigm_job(ParadigmType.SINGLE_TASK_LEARNING.value)#SINGLE_TASK_LEARNING.value:"singletasklearning"
        #print(job)
    ...
    def _train(self, job, initial_model):
        ...
        # print(job): <basemodel.BaseModel object at 0x7f71285d5910>
        # print(train_dataset): <sedna.datasources.TxtDataParse object at 0x7f75b11def10
