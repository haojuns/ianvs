...
class Module:
    ...
    def get_module_instance(self, module_type):
        ...
        if self.url:
            try:
                #print(self.url) : ./examples/curb-detection/latenttask_learning_bench/testalgorithms/rfnet/basemodel.py
                utils.load_module(self.url)#导入对应方法类
                # pylint: disable=E1134
                # 根据t_cls_name注册一个对应的type_class
