...
class TestCase:
    ...
    def run(self, workspace):
        ...
        try:
            ...
            #print('test_env_config:',test_env_config)
            #test_env_config: {'model_eval': {'model_metric': {'name': '', 'url': ''}, 'threshold': 0.9, 'operator': '>'}, 'metrics': [{'name': 'accuracy', 'url': './examples/curb-detection/latenttask_learning_bench/testenv/accuracy.py'}, {'name': 'mIoU', 'url': './examples/curb-detection/latenttask_learning_bench/testenv/mIoU.py'}, {'name': 'samples_transfer_ratio'}], 'incremental_rounds': 2, 'dataset': <core.testenvmanager.dataset.dataset.Dataset object at 0x7fbce668ebe0>}
