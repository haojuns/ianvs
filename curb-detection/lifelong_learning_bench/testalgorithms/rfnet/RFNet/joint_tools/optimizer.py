...
def get_optimizer(args, net):
    ...
    if args.sgd and (args.arch != "network.rfnet.rfnet" and args.arch != "network.erfnet.erfnet"): # 给上面获取的网络层参数添加优化方法
        optimizer = optim.SGD(base_params,
                            lr=args.lr,
                            weight_decay=5e-4, #args.weight_decay,
                            momentum=args.momentum,
                            nesterov=False)
    elif args.arch == "network.rfnet.rfnet":
    ...
    elif args.arch == "network.erfnet.erfnet":
